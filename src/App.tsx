        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Modern, Secure, Customizable</p>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="text-center space-y-6 mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            A beautiful, customizable, and secure CAPTCHA component with multiple verification types,
            perfect for protecting your forms and user interactions.
          </p>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-16">
          <div className="p-6 bg-white rounded-xl shadow-md">
            ...
            <p className="text-gray-600">Built with security best practices and customizable validation rules</p>
          </div>
          <div className="p-6 bg-white rounded-xl shadow-md">
            ...
            <p className="text-gray-600">Screen reader support, keyboard navigation, and audio feedback</p>
          </div>
          <div className="p-6 bg-white rounded-xl shadow-md">
            ...
            <p className="text-gray-600">TypeScript support, comprehensive documentation, and easy integration</p>
          </div>
          <div className="p-6 bg-white rounded-xl shadow-md">
            ...
            <p className="text-gray-600">Minimal bundle size with no external dependencies</p>
          </div>
        </div>
        ...
        <div id="demos" className="space-y-16 mb-16">
          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl shadow-blue-100/50 border border-blue-100 hover:shadow-2xl hover:shadow-blue-100/50 transition-all duration-300">
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 bg-blue-100 rounded-xl">
                    <Hash className="w-6 h-6 text-blue-600" />
                  </div>
                  <div>
                    <h2 className="text-xl font-semibold text-gray-800">Numbers Only</h2>
                    <p className="text-sm text-gray-500">Perfect for numeric verification</p>
                  </div>
                </div>
                <Captcha
                  type="numbers"
              ...
              <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl shadow-purple-100/50 border border-purple-100 hover:shadow-2xl hover:shadow-purple-100/50 transition-all duration-300">
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 bg-purple-100 rounded-xl">
                    <AlphabetLatin className="w-6 h-6 text-purple-600" />
                  </div>
                  <div>
                    <h2 className="text-xl font-semibold text-gray-800">Letters Only</h2>
                    <p className="text-sm text-gray-500">Alphabetic verification challenge</p>
                  </div>
                </div>
                <Captcha
                  type="letters"
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl shadow-orange-100/50 border border-orange-100 hover:shadow-2xl hover:shadow-orange-100/50 transition-all duration-300">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-xl font-semibold text-gray-800">Timed CAPTCHA</h2>
                    <p className="text-sm text-gray-500">Complete within time limit</p>
                  </div>
                </div>
                <Captcha
                  type="mixed"
              ...
              <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl shadow-indigo-100/50 border border-indigo-100 hover:shadow-2xl hover:shadow-indigo-100/50 transition-all duration-300">
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 bg-indigo-100 rounded-xl">
                    <Volume2 className="w-6 h-6 text-indigo-600" />
                  </div>
                  <div>
                    <h2 className="text-xl font-semibold text-gray-800">Accessible CAPTCHA</h2>
                    <p className="text-sm text-gray-500">With audio support and keyboard navigation</p>
                  </div>
                </div>
                <Captcha
                  type="letters"
          ...
          <div className="space-y-8">
            <h3 className="text-2xl font-semibold mb-6">Customization Examples</h3>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-900 p-8 rounded-2xl shadow-xl shadow-gray-900/50 border border-gray-800">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-xl font-semibold text-white">Dark Mode</h2>
                    <p className="text-sm text-gray-400">Elegant dark theme design</p>
                  </div>
                </div>
                <Captcha
                  type="mixed"
              ...
              <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl shadow-green-100/50 border border-green-100 hover:shadow-2xl hover:shadow-green-100/50 transition-all duration-300">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-xl font-semibold text-gray-800">Complex Validation</h2>
                    <p className="text-sm text-gray-500">Custom validation rules</p>
                  </div>
                </div>
                <Captcha
        ...
        <div id="documentation" className="bg-white rounded-2xl shadow-xl p-8 mb-16">
...
function App() {
  ...
  return (
    ...
    />
            ...
            <section className="space-y-6">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left">
                  ...
                  <tbody>
                    <tr className="border-b">
                      <td className="py-4 px-4"><code>type</code></td>
                      <td className="py-4 px-4"><code>'numbers' | 'letters' | 'mixed'</code></td>
                      <td className="py-4 px-4"><code>'mixed'</code></td>
                      <td className="py-4 px-4">Type of CAPTCHA to generate</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-4 px-4"><code>length</code></td>
                      <td className="py-4 px-4"><code>number</code></td>
                      <td className="py-4 px-4"><code>6</code></td>
                      <td className="py-4 px-4">Length of CAPTCHA text</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-4 px-4"><code>darkMode</code></td>
                      <td className="py-4 px-4"><code>boolean</code></td>
                      <td className="py-4 px-4"><code>false</code></td>
                      <td className="py-4 px-4">Enable dark mode theme</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-4 px-4"><code>validationRules</code></td>
                      <td className="py-4 px-4"><code>ValidationRules</code></td>
            ...
            <section className="space-y-6">
              ...
              <div className="space-y-4">
                <p>The <code>validationRules</code> prop accepts an object with the following properties:</p>
  ...
  customValidator?: (value: string) => boolean | string;
            ...
            <section className="space-y-6">
              ...
              <div className="space-y-4">
                <p>Customize the appearance using the <code>className</code> and <code>customStyles</code> props:</p>
                <CodeBlock>{`<Captcha
...
/>`}</CodeBlock>
            ...
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 bg-gray-50 rounded-lg">
                  <kbd className="px-2 py-1 bg-white rounded border shadow-sm">Space</kbd>
                  <p className="mt-2 text-sm text-gray-600">Hear the CAPTCHA code</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-lg">
                  <kbd className="px-2 py-1 bg-white rounded border shadow-sm">Enter</kbd>
                  <p className="mt-2 text-sm text-gray-600">Validate the input</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-lg">
                  <kbd className="px-2 py-1 bg-white rounded border shadow-sm">Escape</kbd>
            ...
            <section className="space-y-6">
              ...
              <div className="space-y-4">
                <p>The component handles various error cases and provides feedback:</p>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-16">
          <div className="text-center space-y-4 mb-8">
            ...
            <p className="text-gray-600">Works seamlessly across all modern browsers</p>
          </div>
